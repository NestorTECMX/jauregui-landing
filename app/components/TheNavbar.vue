  ...
  <header class="navbar" :class="{ 'navbar--scrolled': scrolled }">
    <div class="container navbar__inner">
      ...
      <div class="navbar__right">
        ...
        <!-- WhatsApp CTA -->
        <a href="https://wa.me/528991495634" target="_blank" rel="noopener" class="navbar__wa-btn">
    ...
    <Transition name="mobile">
      <div v-if="mobileOpen" class="navbar__mobile">
        ...
        <a href="https://wa.me/528991495634" target="_blank" class="mobile-wa-btn" @click="mobileOpen = false">
