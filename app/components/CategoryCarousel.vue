          ...
          >
            ...
            <div class="cat-panel__header">
              ...
              <div class="cat-panel__header-right">
                <a
                  :href="`https://wa.me/528997987131?text=Hola%2C%20quiero%20cotizar%20de%3A%20${encodeURIComponent(activeCat.name)}`"
              ...
              <div class="cat-panel__products-section">
                ...
                <div class="products-grid">
                  ...
                  >
                    ...
                    <p class="product-card__name">{{ getProductName(activeCat.id, brand) }}</p>
                  </div>
                </div>
              </div>
            </template>
...
const categories = [
  ...
  },
  {
    ...
    description: 'Cajas de cartón en múltiples medidas, stretch film (emplayador), fleje, esquineros, cinta adhesiva, tecle de paleta y soluciones completas para líneas de empaque industrial.',
    tags: ['Cartón', 'Stretch film', 'Fleje', 'Cinta adhesiva', 'Emplayador', 'Tecle'],
